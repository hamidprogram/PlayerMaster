...
<div class="d-flex justify-content-center">
    <form action="EditArtist.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="formFile" class="form-label" style="color: while;">Artist Photo:</label>
            <input class="form-control" type="file" name="Photoo" value="<?php echo ($row["Photo"]); ?>">
        </div>
